...
class EchoTab extends StatefulWidget {
  const EchoTab({super.key});

  @override
  State<EchoTab> createState() => _EchoScreenState();
}

class _EchoScreenState extends State<EchoTab> with TickerProviderStateMixin {
  ...
  Widget _buildFilter(String label) {
    ...
    return Container(
      ...
      child: FilterChip(
        ...
        shadowColor: Color(0xFF000000).withValues(alpha: 0.3),
